...
## User Story
 - I created this app because I had a problem keeping up with what bag number I was on when I would work on a Lego Set and leave it for a time, such as going back to school. This app will allow me to track what set I was building and what bag I recently completed, allowing me to pick up right where I left off. Secondly, my girlfriend wanted a wishlist of the lego sets I wanted, so she could know which sets I wanted for gifts. In the past my lego wishlist was just simply a page on my notes app I shared with her and this system was janky and confusing. With my lego wishlist feature, it will allow her to see the name of the set, brand, pieces, and price.
